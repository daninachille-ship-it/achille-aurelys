    ...
    try {
      const fpRes = await fetch(`https://formspree.io/f/${FORMSPREE_ID}`, {
        ...
        body: JSON.stringify({
          ...
          message_client: booking.guestMessage || '',
        }),
      });
      if (!fpRes.ok) {
...
<table role="presentation" width="600" style="max-width:600px;width:100%;background:#111827;border:1px solid #1e2a3a;border-radius:4px;overflow:hidden;">
  ...
  <tr><td style="padding:40px 40px 0;text-align:center;">
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 auto 20px;"><tr>
      <td width="56" height="56" align="center" valign="middle" style="width:56px;height:56px;border-radius:50%;background:rgba(200,185,154,.12);border:1px solid #c8b99a;font-size:26px;font-weight:bold;color:#c8b99a;font-family:Arial,Helvetica,sans-serif;line-height:56px;mso-line-height-rule:exactly;text-align:center;">&#10003;</td>
    </tr></table>
